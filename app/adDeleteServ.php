...
//includes the function class
include('functions.php');

//using $_GET it adds the $find serviceID to the adminDeleteService function
if (isset($_GET['info'])) {
    $find = $_GET['info'];
    
    adminDeleteService($find);
...
<head>
    ...
    <title>ARGUS ADMIN DELETE SERVICE</title>
</head>
...
<body>
    <header>
        ...
        <!--If admin delete is successfull, prints this message using ServiceID -->
        <div class="title">
            <h2 data-aos='fade' data-aos-duration='1000' data-aos-delay='500' style="color: white;font-size: 40px; font-family: sans-serif;text-align:center;">
                Service ID : <?php echo "$find" ?> successfully deleted</h2>
        </div>
