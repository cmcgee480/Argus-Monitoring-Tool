...
//includes user.php which holds User class
...
$newUser = new User($fullName,$email,$username,$password);

adminAddNewUser($newUser);
...
<head>
    ...
    <title>ARGUS ADMIN USER UPLOAD</title>
</head>
    ...
    <header>
        ...
        <div class="title">
            <h2 data-aos='fade' data-aos-duration='1000' data-aos-delay='500' style="color: white;font-size: 40px; font-family: sans-serif;text-align:center;">
                Username : <?php echo "$username" ?> successfully added to Argus</h2>
        </div>
